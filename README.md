...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/selenium-requests-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6673&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/selenium-requests-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `selenium-requests` can be installed with:

```
conda install selenium-requests
```

It is possible to list all of the versions of `selenium-requests` available on your platform with:
